...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it is basically a reduce method, with an option of an initial memoized value
  end
  ...
  # ANSWER: it seems like "do end" is a using statement that can dispose/cleanup objects after it exits the scope
